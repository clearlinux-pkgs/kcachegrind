...
Source0  : https://download.kde.org/stable/release-service/21.12.0/src/kcachegrind-21.12.0.tar.xz
...
%prep
%setup -q -n kcachegrind-21.12.0
cd %{_builddir}/kcachegrind-21.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1639630786
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kcachegrind-21.12.0/LICENSES/GFDL-1.2-or-later.txt %{buildroot}/usr/share/package-licenses/kcachegrind/7697008f58568e61e7598e796eafc2a997503fde
cp %{_builddir}/kcachegrind-21.12.0/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kcachegrind/3e8971c6c5f16674958913a94a36b1ea7a00ac46
cp %{_builddir}/kcachegrind-21.12.0/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/kcachegrind/81b58c89ceef8e9f8bd5d00a287edbd15f9d3567
cp %{_builddir}/kcachegrind-21.12.0/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/kcachegrind/19d98e1b6f8ef12849ea4012a052d3907f336c91
pushd clr-build
%make_install
popd
